...
pub struct CreateDepositParams {
    pub addresses: CreateDepositParamsAddresses, // Struct containing all address parameters
    ...
    pub data_list: Vec<H256>, // Array of bytes32 values that can be used for additional data
}

#[derive(Debug, Clone)]
pub struct CreateDepositParamsAddresses {
...
pub struct CreateWithdrawalParams {
    pub addresses: CreateWithdrawalParamsAddresses, // Struct containing all address parameters
...
#[derive(Debug, Clone)]
pub struct CreateWithdrawalParamsAddresses {
...
pub struct CreateShiftParams {
    pub addresses: CreateShiftParamsAddresses, // Struct containing all address parameters
...
#[derive(Debug, Clone)]
pub struct CreateShiftParamsAddresses {
